...
export default function luckysheetcreatedom(colwidth, rowheight, data, menu, title) {
    ...
    gh = replaceHtml(gh, { "rowGroups": `<div class="luckysheet-row-groups" id="luckysheet-row-groups" style="height:${Store.rh_height }px;"><svg><g id="row-groups-lines"></g></svg></div>` });//设置表格宽度
